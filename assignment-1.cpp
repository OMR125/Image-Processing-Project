...
void Shuffle() {
    ...
    for (int i = 0; i < 128; i++) 
        for (int j = 0; j < 128; j++) 
            switch (order[0]) {
                case 1: white_image[i][j] = image[i][j]; break;
                case 2: white_image[i][j] = image[i][j + 128]; break;
                case 3: white_image[i][j] = image[i + 128][j]; break;
                case 4: white_image[i][j] = image[i + 128][j + 128]; break;
            }
    // this loop just run on the 2nd quarter and copys the wanted quarter into it
    for (int i = 0; i < 128; i++)
        for (int j = 0; j < 128; j++)
            switch (order[1]) {
                case 1: white_image[i][j + 128] = image[i][j]; break;
                case 2: white_image[i][j + 128] = image[i][j + 128]; break;
                case 3: white_image[i][j + 128] = image[i + 128][j]; break;
                case 4: white_image[i][j + 128] = image[i + 128][j + 128]; break;
            }
    // this loop just run on the 3rd quarter and copys the wanted quarter into it
    for (int i = 0; i < 128; i++)
        for (int j = 0; j < 128; j++)
            switch (order[2]) {
                case 1: white_image[i + 128][j] = image[i][j]; break;
                case 2: white_image[i + 128][j] = image[i][j + 128]; break;
                case 3: white_image[i + 128][j] = image[i + 128][j]; break;
                case 4: white_image[i + 128][j] = image[i + 128][j + 128]; break;
            }
    // this loop just run on the 4th quarter and copys the wanted quarter into it
    for (int i = 0; i < 128; i++)
        for (int j = 0; j < 128; j++)
            switch (order[3]) {
                case 1: white_image[i + 128][j + 128] = image[i][j]; break;
                case 2: white_image[i + 128][j + 128] = image[i][j + 128]; break;
                case 3: white_image[i + 128][j + 128] = image[i + 128][j]; break;
                case 4: white_image[i + 128][j + 128] = image[i + 128][j + 128]; break;
            }
